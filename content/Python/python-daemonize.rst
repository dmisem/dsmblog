...
* В статье изложен ход решения задачи; окончательное решение находится на `гитхабе`_, развивается и может несколько отличаться от того, как написано в статье;
* Я знаю про StartUP и systemd а также про то, что для python есть готовые решения как на гитхабе, так и на PyPi.  
